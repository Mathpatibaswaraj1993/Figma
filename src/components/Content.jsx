  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-3xl">
        <p className="uppercase tracking-widest text-xs sm:text-sm md:text-base font-medium mb-1 sm:mb-2 md:mb-4">
          Free Sample
        </p>
        <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-2 sm:mb-4 md:mb-6 leading-snug">
          Powerful Generator and Free <br /> Figma Sources
        </h1>
        <p className="text-xs sm:text-sm md:text-lg text-gray-200 max-w-xs sm:max-w-md md:max-w-3xl mx-auto">
